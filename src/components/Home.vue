<template>
    ...
    .animation li {
      position: fixed;
      display: block;
      background: rgba(0, 217, 255, 0.544);
      list-style: none;
    ...
    .animations li {
      position: fixed;
      display: block;
      background: rgba(91, 32, 108, 0.544);
